...
class TelaConfirmacaoSenhaEspaco extends StatelessWidget {
  TelaConfirmacaoSenhaEspaco({Key? key}) : super(key: key);
                        ...
                        child: SizedBox(
                          ...
                          child: OutlinedButton(
                              onPressed: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                      builder: (context) => const TelaSeletoraLocatario()),
                                );
                              },
                              style: OutlinedButton.styleFrom(
                                  backgroundColor: Colors.white,
